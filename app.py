...
# --- 4. CoinDCX API Logic (PERFECT FIX) ---
@st.cache_data(ttl=5)
...
if page_selection == "📈 MAIN TERMINAL":
    ...
    with col2:
        ...
        if market_mode == "🇮🇳 Indian Market (NSE)":
            ...
            p4_chg = (p4_ltp * p4_pct) / 100 if p4_pct else 0.0
            p5_chg = (p5_ltp * p5_pct) / 100 if p5_pct else 0.0
            p6_chg = (p6_ltp * p6_pct) / 100 if p6_pct else 0.0
