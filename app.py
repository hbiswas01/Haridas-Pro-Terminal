...
def process_auto_trades(live_signals, is_crypto_mode):
...
with st.sidebar:
    ...
    # ==========================================
    # 💡 DAILY TRADING RULE (Safe Version)
    # ==========================================
    TRADING_RULES = [
        "১. আত্মনিয়ন্ত্রণই আসল: মার্কেট নয়, নিজের আবেগকে নিয়ন্ত্রণ করুন।",
        "২. 'ট্রেড না করাও' একটি সিদ্ধান্ত: সব সময় মার্কেটে থাকা জরুরি নয়।",
        "৩. ভয় যখন এলার্ম: ভয়কে শিক্ষা হিসেবে নিন, শত্রু হিসেবে নয়।",
        "৪. অতি-আত্মবিশ্বাস থেকে সাবধান: টানা জয়ে নিয়ম ভাঙবেন না।",
        "৫. মানসিকতাই সব: ট্রেড শুরুর আগে মনকে 'রিসেট' করুন।",
        "৬. শৃঙ্খলা যখন পরিচয়: মোটিভেশন না থাকলেও প্রতিদিন নিয়ম মানুন।",
        "৭. লস হলো 'টিউশন ফি': লস থেকে শিক্ষা নিয়ে সামনে এগোন।",
        "৮. ধৈর্য এবং সঠিক সময়: আবেগকে সরিয়ে সঠিক টাইমিংয়ের অপেক্ষা করুন।",
        "৯. স্বচ্ছতা বা স্পষ্টতা: নিজের ভুল স্বীকার করে ডেটার ওপর ফোকাস করুন।",
        "১০. দৃঢ় বিশ্বাস বনাম আশা: 'আশা' নিয়ে নয়, সেটআপের ওপর 'বিশ্বাস' নিয়ে ট্রেড করুন।"
    ]
...
if page_selection == "📈 MAIN TERMINAL":
    ...
    with col2:
        ...
        idx_tv_map = {
            ...
            "Nifty Bank": "NSE:BANKNIFTY", "Fin Nifty": "NSE:CNXFIN", "Nifty IT": "NSE:CNXIT",
